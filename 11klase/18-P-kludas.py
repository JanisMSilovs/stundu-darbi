...
#Uz negatīviem skaitļiem programmai jāsaka "Zaudēji", jo viltnieki nevienam nepatīk. Decimālskaitļi programmā ir paredzēti.
def (punkti)():
    skaits = input("Ievadi punktu skaitu no 1 līdz 16"))
    if skaits == 0:
